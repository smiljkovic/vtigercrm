<?php
/* Smarty version 4.3.4, created on 2024-03-11 20:41:48
  from '/var/www/vtigercrm/layouts/v7/modules/Settings/LayoutEditor/FieldCreate.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_65ef6c8c5c72a9_73560018',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '127bc146247a8209b9c63b5ea9311f4e11d201f0' => 
    array (
      0 => '/var/www/vtigercrm/layouts/v7/modules/Settings/LayoutEditor/FieldCreate.tpl',
      1 => 1710189243,
      2 => 'file',
    ),
  ),
...
function content_65ef6c8c5c72a9_73560018 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
" data-rule-required='true' style='width: 75%' /></div></div><?php if (!$_smarty_tpl->tpl_vars['IS_FIELD_EDIT_MODE']->value) {?><div class="form-group"><label class="control-label fieldLabel col-sm-5"><?php echo vtranslate('Field Name',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
&nbsp;<span class="redColor">*</span></label><div class="controls col-sm-7"><input type="text" class='inputElement col-sm-9' maxlength="50" <?php if ($_smarty_tpl->tpl_vars['IS_FIELD_EDIT_MODE']->value) {?>disabled="disabled"<?php }?> name="fieldName" value="<?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label'),$_smarty_tpl->tpl_vars['SELECTED_MODULE_NAME']->value);?>
" data-rule-alphanumeric='true' style='width: 75%' /></div></div><div class="form-group supportedType lengthsupported"><label class="control-label fieldLabel col-sm-5"><?php echo vtranslate('LBL_LENGTH',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
